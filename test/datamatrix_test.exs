defmodule DataMatrixTest do
  ...
  test "30Q324343430794<OQQ" do
    ...
    {:ok, result} = DataMatrix.encode("30Q324343430794<OQQ", quiet_zone: 0)
  ...
  test "123456" do
    ...
    {:ok, result} = DataMatrix.encode("123456", quiet_zone: 2)
  ...
  test "A1B2C3D4E5F6G7H8I9J0K1L2" do
    ...
    {:ok, result} = DataMatrix.encode("A1B2C3D4E5F6G7H8I9J0K1L2", quiet_zone: 0)
